...
TOKEN = '7218160281:AAE5puQ2DVJwOM-HHcWyKOdiIZOkiozt6Bk'
...
FORWARD_CHANNEL_ID = -1002163780718
CHANNEL_ID = -1002163780718
error_channel_id = -1002163780718
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: just search http canary*", parse_mode='Markdown')
